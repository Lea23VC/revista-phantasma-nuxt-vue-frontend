...
/**
  ...
  *
  * @checksum - c2661987fad459ba161f1d7575680852516f8f7a8bd9c1c276c9948e5c68bf0e
  * @variables - radius=rounded,accentColor=white,colorTemperature=neutral,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-none,tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "family:box__decorator": {
    ...
    "bg-white": true,
    "ring-white-500": true,
    "peer-checked:border-white-600": true,
    "relative": true,
    "block": true,
    "text-lg": true,
    "w-[1em]": true,
    ...
    "peer-checked:bg-white-50": true,
    "peer-checked:text-white-600": true,
    ...
    "dark:ring-offset-white-500": true,
    "dark:peer-focus-visible:ring-1": true,
    "dark:peer-disabled:bg-neutral-600/50": true,
    "dark:peer-checked:bg-white-900": true,
    "dark:peer-checked:text-white-400": true
  },
  ...
  "family:text__inner": {
    ...
    "focus-within:!ring-white-500": true,
    "focus-within:!border-white-500": true,
  ...
  "family:dropdown__listitem": {
    ...
    "text-neutral-700": true,
    "text-base": true,
    "data-[is-active]:bg-white-100": true,
    ...
    "data-[is-active]:before:ring-white-500": true,
    "data-[is-active]:before:ring-inset": true,
    "data-[is-active]:before:ring-offset-white-100": true
  },
  ...
  "family:dropdown__loadMoreInner": {
    ...
    "justify-center": true,
    "[&>span]:mr-2": true,
    "hover:text-white-600": true,
    "cursor-pointer": true,
    "dark:text-neutral-200": true,
    "dark:hover:text-white-500": true
  },
  ...
  "family:dropdown__tagWrapper": {
    ...
    "data-[active-selection=true]:ring-white-500": true
  },
  ...
  "family:dropdown__tag": {
    ...
    "group-data-[active-selection=true]/tag:bg-white-400": true,
  ...
  "family:dropdown__emptyMessage": {
    ...
    "aria-selected:bg-white-600": true
  },
  "button__input": {
    "appearance-none": true,
    "[color-scheme:light]": true,
    ...
    "dark:text-white-500": true,
    "dark:bg-transparent": true,
    "dark:hover:bg-white-50/5": true
  },
  "checkbox__decorator": {
    "rounded": true
  },
  ...
  "date__input": {
    ...
    "selection:text-neutral-700": true,
    "group-data-[has-overlay]:selection:!text-transparent": true,
    "focus:[&::-webkit-datetime-edit-day-field]:bg-white-100": true,
    "focus:[&::-webkit-datetime-edit-month-field]:bg-white-100": true,
    "focus:[&::-webkit-datetime-edit-year-field]:bg-white-100": true
  },
  "datetime-local__input": {
    ...
    "focus:[&::-webkit-datetime-edit-month-field]:bg-white-100": true,
    "focus:[&::-webkit-datetime-edit-year-field]:bg-white-100": true,
    "focus:[&::-webkit-datetime-edit-hour-field]:bg-white-100": true,
    "focus:[&::-webkit-datetime-edit-minute-field]:bg-white-100": true,
    "focus:[&::-webkit-datetime-edit-ampm-field]:bg-white-100": true
  },
  "file__fileList": {
    "group/list": true,
    "peer": true,
  ...
  "file__fileRemove": {
    ...
    "peer-data-[has-multiple]:text-white-600": true,
  ...
  "form__messageLink": {
    ...
    "group-[]/summary:ring-white-600": true
  },
  "month__input": {
    "appearance-none": true,
    "[color-scheme:light]": true,
  ...
  "range__input": {
    ...
    "[&::-webkit-slider-thumb]:bg-white-600": true,
    ...
    "[&::-webkit-slider-thumb]:focus:!ring-white-500": true,
    ...
    "[&::-moz-range-thumb]:bg-white-600": true,
    ...
    "[&::-moz-range-thumb]:focus:!ring-white-500": true,
  ...
  "select__option": {
    ...
    "group-data-[multiple]:checked:bg-white-100": true,
    "group-data-[multiple]:focus:bg-white-100": true,
    ...
    "dark:group-data-[multiple]:focus:bg-white-800": true,
    "dark:group-data-[multiple]:checked:bg-white-800": true
  },
  "select__prefixIcon": {
    "flex": true,
    "items-center": true,
  ...
  "submit__input": {
    ...
    "bg-white-600": true,
    "!text-white": true,
    "active:text-white-100": true,
    "active:bg-white-700": true,
    "hover:bg-white-700": true,
  ...
  "week__input": {
    ...
    "selection:text-neutral-700": true,
    "group-data-[has-overlay]:selection:!text-transparent": true,
    "focus:[&::-webkit-datetime-edit-week-field]:bg-white-100": true,
    "focus:[&::-webkit-datetime-edit-year-field]:bg-white-100": true
  },
  ...
  "colorpicker__control": {
    ...
    "focus-visible:ring-white-500": true
  },
  ...
  "colorpicker__fieldGroup": {
    ...
    "[&>input]:selection:bg-white-100": true,
    "[&>input]:m-0": true,
    "[&>input]:grow": true,
    "[&>input]:shrink": true,
    "[&>input]:w-full": true,
    ...
    "[&>input:focus]:ring-white-600": true,
    "[&>input:focus]:border-white-600": true,
  ...
  "colorpicker__swatch": {
    ...
    "[&>canvas:focus-visible]:ring-white-500": true,
  ...
  "datepicker__dayCell": {
    ...
    "dark:bg-neutral-600": true,
    "dark:text-neutral-300": true,
    "dark:aria-selected:bg-white-600": true,
    "dark:aria-selected:text-white": true,
    "dark:focus:outline-white-600": true,
  ...
  "datepicker__timeInput": {
    ...
    "p-1.5": true,
    "my-2.5": true,
    "focus-visible:outline-white-600": true,
    "dark:text-neutral-300": true,
    "dark:bg-transparent": true,
    "dark:border-neutral-600": true
  },
  ...
  "datepicker__dayButton": {
    ...
    "dark:text-neutral-300": true,
    "dark:border-neutral-600": true,
    "dark:hover:border-white-500": true
  },
  ...
  "datepicker__calendarIcon": {
    "text-neutral-600": true,
    "focus-visible:text-white-600": true,
    "flex": true,
    "w-[1em]": true,
    "grow-0": true,
    "shrink-0": true,
  ...
  "toggle__track": {
    ...
    "transition-all": true,
    "bg-neutral-400": true,
    "peer-checked:bg-white-600": true,
    ...
    "shadow-sm": true,
    "peer-focus-visible:ring-2": true,
    "peer-focus-visible:ring-white-500": true,
  ...
  "togglebuttons__input": {
    ...
    "dark:disabled:text-white-500": true,
    "dark:text-white-500": true,
    "aria-[pressed=\"true\"]:bg-white-600": true,
    "aria-[pressed=\"true\"]:text-white": true,
    "dark:aria-[pressed=\"true\"]:bg-white-600": true,
    ...
    "group-data-[vertical=\"false\"]/options:group-[]/option:aria-[pressed=\"true\"]:border-x-white-500": true,
    "group-data-[vertical=\"false\"]/options:group-first/option:aria-[pressed=\"true\"]:border-l-white-600": true,
    "group-data-[vertical=\"false\"]/options:group-last/option:aria-[pressed=\"true\"]:border-r-white-600": true,
    "dark:group-data-[vertical=\"false\"]/options:group-[]/option:aria-[pressed=\"true\"]:border-x-white-600": true,
    "dark:group-data-[vertical=\"false\"]/options:group-first/option:aria-[pressed=\"true\"]:border-l-white-600": true,
    "dark:group-data-[vertical=\"false\"]/options:group-last/option:aria-[pressed=\"true\"]:border-r-white-600": true,
    ...
    "group-data-[vertical=\"true\"]/options:group-[]/option:aria-[pressed=\"true\"]:border-y-white-500": true,
    "group-data-[vertical=\"true\"]/options:group-first/option:aria-[pressed=\"true\"]:border-t-white-600": true,
    "group-data-[vertical=\"true\"]/options:group-last/option:aria-[pressed=\"true\"]:border-b-white-600": true,
    "dark:group-data-[vertical=\"true\"]/options:group-[]/option:aria-[pressed=\"true\"]:border-y-white-600": true,
    "dark:group-data-[vertical=\"true\"]/options:group-first/option:aria-[pressed=\"true\"]:border-t-white-600": true,
    "dark:group-data-[vertical=\"true\"]/options:group-last/option:aria-[pressed=\"true\"]:border-b-white-600": true
  },
  "transferlist__outer": {
    "group": true,
    "min-w-0": true,
    ...
    "text-base": true,
    "max-w-none": true,
    "[&_.dnd-placeholder]:bg-white-600": true,
  ...
  "transferlist__transferlist": {
    ...
    "[&:has(:focus-visible)]:ring-white-500": true,
    "dark:border-neutral-600": true,
  ...
  "transferlist__transferlistListItem": {
    ...
    "aria-selected:bg-white-100": true,
    "data-[is-active=true]:bg-white-100": true,
    "data-[is-active=true]:ring-white-200": true,
    "aria-selected:ring-white-200": true,
    "relative": true,
    "flex": true,
    "cursor-pointer": true,
    "items-center": true,
    ...
    "dark:bg-neutral-800": true,
    "dark:text-neutral-300": true,
    "dark:data-[is-active=true]:bg-white-900": true,
    "dark:aria-selected:bg-white-900": true,
    "dark:ring-neutral-700": true,
    "dark:data-[is-active=true]:ring-white-600": true,
    "dark:aria-selected:ring-white-600": true,
    "[&.formkit-dropZone]:bg-white-100": true,
    "[&.formkit-selectionDropZone]:bg-white-100": true,
    "[&.formkit-touchDropZone]:bg-white-100": true,
    "[&.formkit-touchSelectionDropZone]:bg-white-100": true,
    "[&.formkit-longTouch]:bg-white-100": true,
    "dark:[&.formkit-dropZone]:bg-white-900": true,
    "dark:[&.formkit-selectionDropZone]:bg-white-900": true,
    "dark:[&.formkit-touchDropZone]:bg-white-900": true,
    "dark:[&.formkit-touchSelectionDropZone]:bg-white-900": true,
    "dark:[&.formkit-longTouch]:bg-white-900": true
  },
  ...
  "transferlist__transferlistSearch": {
    ...
    "dark:border-neutral-600": true,
    "dark:text-neutral-300": true,
    "dark:selection:bg-white-100": true,
    "dark:selection:text-neutral-700": true,
    "dark:bg-neutral-800": true
  },
  ...
  "multi-step__tab": {
    ...
    "group-data-[tab-style=\"progress\"]/wrapper:data-[valid=\"true\"]:data-[visited=\"true\"]:after:bg-white-600": true,
    ...
    "dark:group-data-[tab-style=\"progress\"]/wrapper:data-[valid=\"true\"]:data-[visited=\"true\"]:after:bg-white-600": true
  },
  ...
  "multi-step__badge": {
    ...
    "text-white": true,
    "rounded-full": true,
    "group-data-[valid=\"true\"]/tab:bg-white-600": true,
